...
func _passes_mapping(reference_sample: GaeaValue.Sample, cell: Vector3i, graph: GaeaGraph, pouch: GaeaGenerationPouch) -> bool:
	var range_value: Dictionary = _get_arg(&"range", graph, pouch)
